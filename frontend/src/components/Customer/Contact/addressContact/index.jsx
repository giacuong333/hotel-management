    ...
    return (
        <div>
            <div className="container">
                <div
                    className=""
                    style={{ display: 'flex', fontFamily: 'Nanum Myeongjo', fontSize: '1.5rem', lineHeight: '3rem' }}
                >
                    ...
                    <div className="col-lg-6 " style={{ position: 'relative', marginLeft: '-3rem', marginTop: '7rem' }}>
                        <div
                            ...
                            style={{
                                background: `url(${contact_address_img2})`,
                                position: 'relative',
                                height: '40rem',
                        ...
                        >
                            <div className="col-lg-6 text-center " style={{ marginTop: '10rem' }}>
                                ...
                                <p>Nordstrom NYC Flagship 222 West 56th Street, New York, NY 10019</p>
